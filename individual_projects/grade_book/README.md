...
***
1. Make sure the CSV is valid: individual_projects/grade_book/docs/students.csv
2. Run the program 
3. Use the nubmered main meny to choose an option and press enter
4. Exit the program by choosing the "Exit" option

## List of key features
***
- Add new students with name and ID
- Add grades for each student
- Automatically calculates average grades and letters
- List all students along with total number of students
- View individual student records with full details
- Uses CSV file to save student data
